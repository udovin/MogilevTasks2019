...
def main():
	...
	for i in range(10):
		input_file = "tests/group1/{}".format(i + 1)
		output_file = "tests/group1/{}.a".format(i + 1)
		generate(input_file, 1, randint(3, 4), randint(1, 500))
		run_test(input_file, output_file)
	for i in range(10):
		input_file = "tests/group2/{}".format(i + 1)
		output_file = "tests/group2/{}.a".format(i + 1)
		generate(input_file, 1, randint(5, 500), randint(1, 500))
		run_test(input_file, output_file)
	for i in range(10):
		input_file = "tests/group3/{}".format(i + 1)
		output_file = "tests/group3/{}.a".format(i + 1)
		generate(input_file, randint(2, 500), randint(3, 4), randint(1, 500))
		run_test(input_file, output_file)
	for i in range(20):
		input_file = "tests/group4/{}".format(i + 1)
		output_file = "tests/group4/{}.a".format(i + 1)
